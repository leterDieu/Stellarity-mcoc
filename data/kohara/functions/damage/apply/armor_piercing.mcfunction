...
$execute if score #armor_penetration kohara.misc matches 100 run damage @s $(damage_ap) $(type_ap)$(attacker)
$execute unless score #armor_penetration kohara.misc matches 100 run damage @s $(damage_ap) $(type_ap)
