...
execute if score out foka.misc matches 1 run data modify storage fokastudio:end/temp villager_trades append value {maxUses:3,rewardExp:1b,priceMultiplier:0.2,demand:3,specialPrice:0,buy:{id:"emerald",Count:33,tag:{}},buyB:{id:"air",Count:1,tag:{}},sell:{id:"diamond_sword",Count:1,tag:{}}}
