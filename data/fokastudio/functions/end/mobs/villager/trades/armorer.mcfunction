...
execute if score out foka.misc matches 1 run data modify storage fokastudio:end/temp villager_trades append value {maxUses:3,rewardExp:1b,priceMultiplier:0.2,demand:3,specialPrice:0,buy:{id:"emerald",Count:34,tag:{}},buyB:{id:"air",Count:1,tag:{}},sell:{id:"diamond_helmet",Count:1,tag:{}}}
execute if score out foka.misc matches 1 run data modify storage fokastudio:end/temp villager_trades append value {maxUses:3,rewardExp:1b,priceMultiplier:0.2,demand:3,specialPrice:0,buy:{id:"emerald",Count:37,tag:{}},buyB:{id:"air",Count:1,tag:{}},sell:{id:"diamond_chestplate",Count:1,tag:{}}}
execute if score out foka.misc matches 2 run data modify storage fokastudio:end/temp villager_trades append value {maxUses:3,rewardExp:1b,priceMultiplier:0.2,demand:3,specialPrice:0,buy:{id:"emerald",Count:35,tag:{}},buyB:{id:"air",Count:1,tag:{}},sell:{id:"diamond_leggings",Count:1,tag:{}}}
execute if score out foka.misc matches 2 run data modify storage fokastudio:end/temp villager_trades append value {maxUses:3,rewardExp:1b,priceMultiplier:0.2,demand:3,specialPrice:0,buy:{id:"emerald",Count:32,tag:{}},buyB:{id:"air",Count:1,tag:{}},sell:{id:"diamond_boots",Count:1,tag:{}}}
...
data modify storage fokastudio:end/temp villager_trades append value {maxUses:3,rewardExp:1b,priceMultiplier:0.05,demand:3,specialPrice:0,buy:{id:"emerald",Count:9,tag:{}},buyB:{id:"air",Count:1,tag:{}},sell:{id:"shield",Count:1,tag:{}}}
