...
scoreboard players operation #last_rest foka.misc = @s foka.misc.time_since_rest
...
scoreboard players operation #last_rest foka.misc /= #half_hour foka.misc
...
scoreboard players operation #size foka.misc *= #4 foka.misc
