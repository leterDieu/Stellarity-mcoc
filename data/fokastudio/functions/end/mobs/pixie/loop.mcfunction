...
execute if score @s foka.misc matches 75 run function fokastudio:end/mobs/pixie/sounds/ambient

execute store result score @s foka.misc2 run data get entity @s HurtTime
execute if score @s foka.misc2 matches 9.. run function fokastudio:end/mobs/pixie/sounds/hurt
