...
scoreboard objectives add foka.misc.end_portal_eyes_consumed dummy "End Portal Animation Progress 2"
scoreboard objectives add foka.misc.end_portal_bg_loop dummy "End Portal Animation Progress 3"
