scoreboard players set @s foka.items.prismatic_pearl.cooldown 100
...
execute if entity @s[name="Bush_King",predicate=fokastudio:end/utils/chance/50percent] as @e[type=ender_pearl,limit=1,sort=nearest] run tag @s add foka.prismatic_pearl.bush
