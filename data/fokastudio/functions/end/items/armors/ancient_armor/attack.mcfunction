...
execute unless score @s foka.items.armors.ancient_armor.combo matches 1.. run attribute @s generic.attack_damage modifier add 5ec8048e-f25b-11ec-b939-0242ac120002 "wrath_of_the_ancients" 0.07 multiply_base
attribute @s[scores={foka.items.armors.ancient_armor.combo=1}] generic.attack_damage modifier add 5ec8048e-f25b-11ec-b939-0242ac120002 "wrath_of_the_ancients" 0.14 multiply_base
attribute @s[scores={foka.items.armors.ancient_armor.combo=2}] generic.attack_damage modifier add 5ec8048e-f25b-11ec-b939-0242ac120002 "wrath_of_the_ancients" 0.21 multiply_base
attribute @s[scores={foka.items.armors.ancient_armor.combo=3}] generic.attack_damage modifier add 5ec8048e-f25b-11ec-b939-0242ac120002 "wrath_of_the_ancients" 0.28 multiply_base
