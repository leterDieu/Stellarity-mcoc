...
execute unless score @s foka.items.armors.ancient_armor.combo matches 1.. run attribute @s generic.attack_damage modifier add 5ec8048e-f25b-11ec-b939-0242ac120002 "wrath_of_the_ancients" 0.05 multiply_base
attribute @s[scores={foka.items.armors.ancient_armor.combo=1}] generic.attack_damage modifier add 5ec8048e-f25b-11ec-b939-0242ac120002 "wrath_of_the_ancients" 0.1 multiply_base
attribute @s[scores={foka.items.armors.ancient_armor.combo=2}] generic.attack_damage modifier add 5ec8048e-f25b-11ec-b939-0242ac120002 "wrath_of_the_ancients" 0.15 multiply_base
attribute @s[scores={foka.items.armors.ancient_armor.combo=3}] generic.attack_damage modifier add 5ec8048e-f25b-11ec-b939-0242ac120002 "wrath_of_the_ancients" 0.2 multiply_base
attribute @s[scores={foka.items.armors.ancient_armor.combo=4}] generic.attack_damage modifier add 5ec8048e-f25b-11ec-b939-0242ac120002 "wrath_of_the_ancients" 0.25 multiply_base
...
scoreboard players set @s foka.items.armors.ancient_armor.until_combo_reset 100
