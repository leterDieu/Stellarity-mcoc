execute unless entity @s[tag=foka.items.dragonblade.punch_ready] anchored eyes rotated ~ 0 run particle firework ^ ^1.5 ^ 0 0 0 0.08 18 force @a[predicate=fokastudio:end/items/holding_dragonblade]
