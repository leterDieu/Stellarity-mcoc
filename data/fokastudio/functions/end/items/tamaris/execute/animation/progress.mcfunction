...
execute if score @s foka.items.tamaris.animation.progress matches 5 run scoreboard players set @s foka.items.tamaris.execute_cooldown 3
execute if score @s foka.items.tamaris.animation.progress matches 5 run tag @s add foka.items.tamaris.no_warn
execute if score @s foka.items.tamaris.animation.progress matches 5 as @e[type=!#fokastudio:end/invalid_targets,distance=0.1..16,limit=1,sort=nearest,tag=foka.items.tamaris.executable] run function fokastudio:end/items/tamaris/execute/animation/as_entity/2
