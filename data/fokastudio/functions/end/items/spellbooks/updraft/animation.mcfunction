scoreboard players add @s foka.items.spellbook.updraft.animation 1

execute if score @s foka.items.spellbook.updraft.animation matches ..20 run particle minecraft:cloud ~ ~ ~ 0 0 0 0.05 3 force @a[distance=..48]
