...
execute if predicate fokastudio:end/utils/below_y_0 run title @p[predicate=fokastudio:end/void_fishing/holding_fishing_rod/any] actionbar {"translate":"foka.void_fishing.warning","fallback": "Something tells you you should fish higher...","color":"dark_purple"}
