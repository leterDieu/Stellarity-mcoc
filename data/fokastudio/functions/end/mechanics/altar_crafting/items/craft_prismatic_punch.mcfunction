kill @e[type=item,tag=foka.altar_of_the_accursed.crossbow,distance=..1.5,limit=1]
kill @e[type=item,tag=foka.altar_of_the_accursed.24_pixie_dust,distance=..1.5,limit=1]
kill @e[type=item,tag=foka.altar_of_the_accursed.6_diamonds,distance=..1.5,limit=1]
