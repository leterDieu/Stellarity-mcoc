...
kill @e[type=item,tag=foka.altar_of_the_accursed.10_pixie_dust,distance=..1.5,limit=1]
kill @e[type=item,tag=foka.altar_of_the_accursed.5_gold_ingots,distance=..1.5,limit=1]
