data modify storage fokastudio:end/temp enchants set from entity @e[type=item,tag=foka.altar_of_the_accursed.netherite_shovel,distance=..1.5,limit=1] Item.tag.Enchantments

kill @e[type=item,tag=foka.altar_of_the_accursed.shulker_shells,distance=..1.5,limit=1]
kill @e[type=item,tag=foka.altar_of_the_accursed.netherite_shovel,distance=..1.5,limit=1]
