...
function stellarity:utils/tellraw/config {title:"Dragon Music Loop Delay",description:"Number of ticks Dragon's boss theme is going to loop after. Only edit if you actually have a reason to.",default:'{"text":"4220","color":"#EEEEEE"}',score:"stellarity.config.track_loop_delay.dragon",numerical:1,suggested_value:4220}
