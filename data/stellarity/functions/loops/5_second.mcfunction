...
execute as @e[type=marker,tag=stellarity.altar_of_accursed,predicate=stellarity:utils/chance/3percent,tag=stellarity.aota_activated] at @s run function stellarity:sfx/altar_of_the_accursed/soul_escape
