...
execute if entity @s[predicate=stellarity:items/wearing_full_chorus_champion_armor,predicate=kohara:player/is_running,predicate=!kohara:player/is_swimming] rotated as @s rotated ~ 0 positioned ^ ^ ^-.33 run function stellarity:items/armors/chorus_champion_armor/visuals
