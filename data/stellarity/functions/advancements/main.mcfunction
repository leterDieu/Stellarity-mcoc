...
execute if entity @s[scores={stellarity.misc.used_ender_pearl=1..},advancements={stellarity:adventure/beam_me_up=false}] run function stellarity:advancements/beam_me_up/throw
...
execute if entity @s[advancements={stellarity:end_city/super_sonic=false},scores={stellarity.misc.flight_speed=20..}] unless block ^ ^1 ^ #stellarity:non_solid unless block ^ ^-1 ^ #stellarity:non_solid unless block ^1 ^ ^ #stellarity:non_solid unless block ^-1 ^ ^ #stellarity:non_solid run advancement grant @s only stellarity:end_city/super_sonic
