...
execute if data storage stellarity:temp cauldron_crafting.item.tag."stellarity.special_item" run \
	data modify storage stellarity:temp cauldron_crafting.ingredients append from storage stellarity:temp cauldron_crafting.item.tag."stellarity.special_item"

execute unless data storage stellarity:temp cauldron_crafting.item.tag."stellarity.special_item" run \
