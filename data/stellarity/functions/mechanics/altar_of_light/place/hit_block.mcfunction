...
execute align xyz positioned ~.5 ~ ~.5 run summon item_display ~ ~0.5 ~ {item:{id:"minecraft:chiseled_quartz_block",Count:1b,tag:{CustomModelData:90000}},brightness:{block:15,sky:15}}
