...
execute unless predicate stellarity:locations/in_dragons_den if predicate stellarity:utils/below_y_0 run title @p[predicate=stellarity:void_fishing/holding_fishing_rod/any] actionbar {"translate":"stellarity.void_fishing.warning.too_deep","fallback": "Something tells you you should fish higher...","color":"dark_purple"}

execute unless predicate stellarity:locations/in_dragons_den unless predicate stellarity:utils/below_y_0 run function stellarity:mechanics/void_fishing/as_bobber/start
