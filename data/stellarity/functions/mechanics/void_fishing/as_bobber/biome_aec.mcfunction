execute if biome ~ ~ ~ stellarity:blazing_dunes run \
	...
	{Radius:1.8,Particle:"flame",Tags:["stellarity.void_fishing_aec","stellarity.aec"],Duration:2147483647}

execute if biome ~ ~ ~ stellarity:crystal_crags run \
	summon area_effect_cloud ~ ~ ~ \
	{Radius:1.8,Particle:"witch",Tags:["stellarity.void_fishing_aec","stellarity.aec"],Duration:2147483647}
...
execute if biome ~ ~ ~ far_end:warped_marsh run \
	summon area_effect_cloud ~ ~ ~ \
	{Radius:1.8,Particle:"splash",Tags:["stellarity.void_fishing_aec","stellarity.aec"],Duration:2147483647}
...
execute if biome ~ ~ ~ stellarity:the_hallow run \
	summon area_effect_cloud ~ ~ ~ \
	{Radius:1.8,Particle:"end_rod",Tags:["stellarity.void_fishing_aec","stellarity.aec"],Duration:2147483647}

execute if biome ~ ~ ~ far_end:ashfall_delta run \
	summon area_effect_cloud ~ ~ ~ \
	{Radius:1.8,Particle:"smoke",Tags:["stellarity.void_fishing_aec","stellarity.aec"],Duration:2147483647}
...
execute if biome ~ ~ ~ far_end:void run \
	summon area_effect_cloud ~ ~ ~ \
	{Radius:1.8,Particle:"dragon_breath",Tags:["stellarity.void_fishing_aec","stellarity.aec"],Duration:2147483647}

execute if biome ~ ~ ~ far_end:flesh_tundra run \
	summon area_effect_cloud ~ ~ ~ \
	{Radius:1.8,Particle:"instant_effect",Tags:["stellarity.void_fishing_aec","stellarity.aec"],Duration:2147483647}
...
execute if biome ~ ~ ~ stellarity:sculk_growth run \
	summon area_effect_cloud ~ ~ ~ \
	{Radius:1.8,Particle:"sculk_charge_pop",Tags:["stellarity.void_fishing_aec","stellarity.aec"],Duration:2147483647}
