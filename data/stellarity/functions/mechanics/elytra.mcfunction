...
# Boost nerf
execute if score #stellarity.config stellarity.config.nerf_elytra matches 1 if entity @s[gamemode=!creative,gamemode=!spectator,predicate=kohara:player/has_boosted_with_elytra] run function stellarity:mechanics/elytra_nerf/boost
