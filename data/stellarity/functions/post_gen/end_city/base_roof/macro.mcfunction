execute store result score #random stellarity.misc run random value 1..5
...
$execute if score #random stellarity.misc matches 5 run place template stellarity:end_city/base_roof/4 ~ ~ ~ $(direction)
