...
execute unless score #armor_penetration stellarity.misc matches 100 run data modify entity @s[type=!player] Silent set value 1b
...
execute unless score #silent stellarity.misc matches 1 run data modify entity @s[type=!player] Silent set value 0b
scoreboard players reset #silent stellarity.misc
