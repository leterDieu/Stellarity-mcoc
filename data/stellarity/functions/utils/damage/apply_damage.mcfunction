execute if score #damage_ap stellarity.misc matches 1.. run function stellarity:utils/damage/apply/armor_piercing
...
execute if entity @s[tag=stellarity.damage.dragonblade] run function stellarity:utils/damage/apply/dragonblade
execute if entity @s[tag=stellarity.damage.natures_wrath] run function stellarity:utils/damage/apply/natures_wrath
execute if entity @s[tag=stellarity.damage.dot.dark_decay] run function stellarity:utils/damage/apply/dark_decay
execute if entity @s[tag=stellarity.damage.dot.prismatic_inferno] run function stellarity:utils/damage/apply/prismatic_inferno
execute if entity @s[tag=stellarity.damage.dot.frostburn] run function stellarity:utils/damage/apply/frostburn
execute if entity @s[tag=stellarity.damage.kaleidoscope] run function stellarity:utils/damage/apply/kaleidoscope
