...
execute if entity @s[tag=stellarity.damage.carcanet] run function stellarity:damage/death_messages/starstruck_carcanet

#> Spirit Dagger teleport slash
execute if entity @s[tag=stellarity.damage.spirit_dagger] run function stellarity:damage/death_messages/spirit_dagger

#> Dragon punch
execute if entity @s[tag=stellarity.damage.dragonblade] run function stellarity:damage/death_messages/dragonblade

#> Tamaris
execute if entity @s[tag=stellarity.damage.tamaris_execute] run function stellarity:damage/death_messages/tamaris

#> Prismatic Inferno
execute if entity @s[tag=stellarity.damage.dot.prismaric_inferno] run function stellarity:damage/death_messages/prismatic_inferno

#> Frostburn
execute if entity @s[tag=stellarity.damage.dot.frostburn] run function stellarity:damage/death_messages/frostburn

#> Nature's Wrath
execute if entity @s[tag=stellarity.damage.natures_wrath] run function stellarity:damage/death_messages/natures_wrath

#> Kaleidoscope
execute if entity @s[tag=stellarity.damage.kaleidoscope] run function stellarity:damage/death_messages/kaleidoscope
