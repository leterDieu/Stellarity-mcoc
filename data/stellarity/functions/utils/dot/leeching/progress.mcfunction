...
execute if score @s stellarity.dot.leeching.progress = @s stellarity.dot.leeching.delay run function stellarity:utils/dot/leeching/heal
...
execute if score @s stellarity.dot.leeching.time matches 0 run function stellarity:utils/dot/leeching/timeout
