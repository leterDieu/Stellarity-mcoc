...
execute if data storage stellarity:temp {item_nbt:{Item:{id:"minecraft:structure_void",tag:{stellarity.custom_mob_death_sound:1b}}}} run function stellarity:utils/mob_death_sounds/play
