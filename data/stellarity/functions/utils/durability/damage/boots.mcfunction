...
execute if score $player.out_0 stellarity.misc matches -1..0 run playsound minecraft:entity.item.break player @a[distance=..16]
execute if score $player.out_0 stellarity.misc matches -1..0 run item replace entity @s armor.feet with minecraft:air
