...
data merge entity @s {PierceLevel:4b,Tags:["stellarity.spectral_bolt"],NoGravity:1b,Duration:200,Silent:0b,pickup:0b,SoundEvent:"minecraft:block.amethyst_cluster.break"}
