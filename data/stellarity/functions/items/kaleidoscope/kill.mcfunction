...
execute if score @s[advancements={stellarity:events/items/attack/kaleidoscope=false}] stellarity.items.kaleidoscope.charge matches ..32 anchored eyes positioned ^ ^ ^2.5 run function stellarity:items/kaleidoscope/charges/0
