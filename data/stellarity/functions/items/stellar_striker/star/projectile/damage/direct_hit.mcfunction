...
function kohara:damage/calculate {armor_penetration:50,damage_boost_efficiency:80,damage_type:"kohara:ignores_iframes",tag:"stellarity.damage.stellar_striker"}
