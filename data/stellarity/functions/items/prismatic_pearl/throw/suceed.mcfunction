...
execute if entity @s[name="Bush_King",predicate=kohara:chance/50percent] as @e[type=ender_pearl,limit=1,sort=nearest] run tag @s add stellarity.prismatic_pearl.bush
