...
summon minecraft:marker ^ ^ ^ {Tags:["stellarity.prismatic_blast","stellarity.prismatic_blast.monochrome","stellarity.marker"]}
...
summon minecraft:marker ^ ^ ^ {Tags:["stellarity.prismatic_blast","stellarity.prismatic_blast.pastel","stellarity.marker"]}
