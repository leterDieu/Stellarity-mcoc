...
execute unless score @s stellarity.items.prismatic_punch.piercing_cooldown matches 1.. anchored eyes if entity @e[type=!#kohara:invalid_targets,distance=..2.5,limit=1,sort=nearest,predicate=!stellarity:items/holding/prismatic_punch] run function stellarity:items/prismatic_punch/detonate/start
