...
execute if entity @s[predicate=!stellarity:items/holding_ender_insignia,tag=stellarity.ender_insignia.active] run function stellarity:items/ender_insignia/stop_sneaking
