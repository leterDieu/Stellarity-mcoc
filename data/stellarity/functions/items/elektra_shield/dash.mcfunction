...
# Damage
execute as @e[type=!#stellarity:invalid_targets,distance=0.01..2.5,nbt={HurtTime:0s}] at @s run function stellarity:items/elektra_shield/dash/damage
...
execute rotated ~ 0 anchored feet unless block ^ ^.1 ^1.7 #stellarity:non_solid run function stellarity:items/elektra_shield/dash/end
