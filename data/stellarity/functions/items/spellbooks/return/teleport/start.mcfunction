...
data modify storage stellarity:temp book_of_return.player_data set from entity @p[predicate=stellarity:items/spellbooks/holding_return]
...
tag @p[predicate=stellarity:items/spellbooks/holding_return] add stellarity.book_of_return.teleport
