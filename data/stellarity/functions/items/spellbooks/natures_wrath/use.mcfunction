...
execute if score #mainhand stellarity.misc matches 0 run loot replace entity @s weapon.offhand loot stellarity:items/spellbooks/natures_wrath
execute if score #mainhand stellarity.misc matches 0 run item modify entity @s weapon.offhand stellarity:natures_wrath_update_biomes
execute if score #mainhand stellarity.misc matches 1 run loot replace entity @s weapon.mainhand loot stellarity:items/spellbooks/natures_wrath
execute if score #mainhand stellarity.misc matches 1 run item modify entity @s weapon.mainhand stellarity:natures_wrath_update_biomes
