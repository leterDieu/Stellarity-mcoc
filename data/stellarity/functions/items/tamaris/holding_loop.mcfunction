...
execute as @e[type=!#stellarity:invalid_targets,tag=stellarity.items.tamaris.executable,distance=..20] at @s anchored eyes rotated ~ 0 run function stellarity:items/tamaris/execute/indicator
