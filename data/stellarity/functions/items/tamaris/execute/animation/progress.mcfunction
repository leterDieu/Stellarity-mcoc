...
## DEBUG
# And fun tbh
#execute if score @s stellarity.items.tamaris.animation.progress matches 1 as @e[type=!#stellarity:invalid_targets,distance=0.1..100,limit=1,sort=nearest,tag=stellarity.items.tamaris.executable] at @s run tp ~50 ~ ~
...
execute if score @s stellarity.items.tamaris.animation.progress matches 5 as @e[type=!#stellarity:invalid_targets,distance=0.1..100,limit=1,sort=nearest,tag=stellarity.items.tamaris.executable] run function stellarity:items/tamaris/execute/animation/as_entity/2
