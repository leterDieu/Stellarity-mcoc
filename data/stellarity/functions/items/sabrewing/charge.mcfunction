...
# Charge sounds
execute if score @s stellarity.items.sabrewing.charge matches 60 run playsound block.respawn_anchor.charge player @s ~ ~ ~ 0.4 1.2
execute if score @s stellarity.items.sabrewing.charge matches 60 run playsound minecraft:block.chorus_flower.grow player @s ~ ~ ~ 1 0.9
