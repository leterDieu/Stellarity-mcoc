...
execute if score #homing stellarity.misc matches 0 run tp @s ^ ^ ^1 ~ ~
execute if score #homing stellarity.misc matches 1 \
	anchored eyes facing entity @e[type=!#kohara:invalid_targets_with_player,distance=..16,limit=1,sort=nearest,tag=!stellarity.spectral_fury.untargettable] eyes positioned ^ ^ ^3.6 rotated as @s positioned ^ ^ ^5 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^ ^ ^1 ~ ~
