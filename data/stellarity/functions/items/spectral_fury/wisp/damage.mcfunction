...
execute if entity @e[type=!#kohara:invalid_targets_with_player,distance=0.01..16,tag=!stellarity.spectral_fury.untargettable] run tag @s add stellarity.spectral_fury.untargettable
