...
execute as @e[type=end_crystal,predicate=stellarity:locations/in_the_end,nbt={ShowBottom:1b}] at @s run function stellarity:sfx/dragon_respawn_animation/crystal_transition
execute as @e[type=end_crystal,tag=fe.respawn_crystal] at @s run function stellarity:sfx/dragon_respawn_animation/respawn_crystal_transition
